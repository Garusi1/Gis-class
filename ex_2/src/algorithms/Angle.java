...
//  private Angle() {}
   ...
   */
  public static double angle(Geom.Point3D p0, Geom.Point3D p1) {
      double dx = p1.x() - p0.x();
      double dy = p1.y() - p0.y();
   ...
   */
  public static double angle(Geom.Point3D p) {
   ...
   */
  public static boolean isAcute(Geom.Point3D p0, Geom.Point3D p1, Geom.Point3D p2)
  {
   ...
   */
  public static boolean isObtuse(Geom.Point3D p0, Geom.Point3D p1, Geom.Point3D p2)
  {
   ...
   */
  public static double angleBetween(Geom.Point3D tip1, Geom.Point3D tail,
			Geom.Point3D tip2) {
   ...
   */
  public static double angleBetweenOriented(Geom.Point3D tip1, Geom.Point3D tail,
			Geom.Point3D tip2) 
  {
		double a1 = angle(tail, tip1);
		double a2 = angle(tail, tip2);
  ...
  /**
	 ...
	 */
  public static double interiorAngle(Geom.Point3D p0, Geom.Point3D p1, Geom.Point3D p2)
  {
